class RealTimeConnectionModel {
    ...
    getNumberOfConnections(registration_number) {
        const companyServers = this.#connectionsData.get(registration_number)
    ...
    getNumberOfConnectionsInContinent(registration_number, continentCode) {
        const companyServers = this.#connectionsData.get(registration_number)
        ...
        companyServers.forEach((serverData) => {
            serverData.connectionsData.connections.forEach((connection) => {
                if (connection[2].continentCode == continentCode) {
                    totalConnections++;
                }
            })
    ...
    getNumberOfActiveServers(registration_number) {
        return this.#connectionsData.get(registration_number).size
    }

    getNumberOfActiveServersInContinent(registration_number, continentCode) {
        const companyServers = this.#connectionsData.get(registration_number)
...
realTimeModel.mapConnectionsData({
        'server_data': {
            ...
            'port': 25565,
            'legal_name': 'Mojang Studios',
            'registration_number': 'SE000000000002',
            'continent': 'South America',
            'continentCode': 'SA',
            'country': 'Brazil',
            'region': 'SP',
...
console.log(realTimeModel.getNumberOfActiveServersInContinent("SE000000000002", "SA"))